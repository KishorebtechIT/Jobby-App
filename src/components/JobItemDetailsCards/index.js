...
class JobItemDetailsCards extends Component {
  ...
  getJobItemDetails = async () => {
    ...
    const employmentType = checkedBoxes.join()
    const options = {
      headers: {
    ...
    const apiUrl = `https://apis.ccbp.in/jobs?employment_type=${employmentType}&minimum_package=${salaryFilter}&search=${searchInput}`
    console.log(apiUrl)
